...
<h4>Fork for aiogram 3.x from <a href="https://github.com/netbriler/aiogram-peewee-template">netbriler/aiogram-peewee-template aiogram 2.x</a></h4>
...
```
### Database
By default postgres you can configurate it
...
then init languages
```bash
$ pybabel init -i locales/bot.pot -d locales -D bot -l <language code>
# or if you have make you can simply type 
$ make pybabel_init <language code>
```
finaly translate messages in `locales/<language code>/LC_MESSAGES/bot.po` and compile translations
```bash
...
│   ├───factory         # aiogram factory for callbacks
